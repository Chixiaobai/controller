...
#include "rosidl_runtime_c/primitives_sequence.h"  // reference_joint_angles
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // reference_joint_angles
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: reference_joint_angles
  {
    size_t size = ros_message->reference_joint_angles.size;
    auto array_ptr = ros_message->reference_joint_angles.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: reference_joint_angles
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->reference_joint_angles.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->reference_joint_angles);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->reference_joint_angles, size)) {
      fprintf(stderr, "failed to create array for field 'reference_joint_angles'");
      return false;
    }
    auto array_ptr = ros_message->reference_joint_angles.data;
  ...
  size_t current_alignment)
{
  ...
  // field.name reference_joint_angles
  {
    size_t array_size = ros_message->reference_joint_angles.size;
    auto array_ptr = ros_message->reference_joint_angles.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
