...
#include "main.h"
class GrpcJointMaxVelParamsTest : public GrpcParamsTest,
                                public testing::TestWithParam<std::vector<JointMaxParams>>
{
protected:
...
TEST_F(GrpcParamsTest, H10w_FT_Grpc_Params_007)
{
    std::cout << "验证获取关节最大速度函数有效性" << std::endl;
